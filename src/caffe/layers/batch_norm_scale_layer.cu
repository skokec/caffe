...
void BatchNormScaleLayer<Dtype>::multicast_gpu(int N, int C, int S,
...
// y[c] = sum x(.,c,...)
template <typename Dtype>
void BatchNormScaleLayer<Dtype>::compute_sum_per_channel_gpu(int N, int C, int S,
    const Dtype *x, Dtype *y ) {
...
// y[c] = mean x(.,c,...)
template <typename Dtype>
void BatchNormScaleLayer<Dtype>::compute_mean_per_channel_gpu(int N, int C, int S,
    const Dtype *x, Dtype *y ) {
  Dtype F = 1.0 / (N*S);
...
/*template void BatchNormScaleLayer<float>::multicast_gpu(int N, int C,
    int S, const float *x, float *y);
template void BatchNormScaleLayer<float>::compute_sum_per_channel_gpu(int N, int C,
    int S, const float *x, float *y);
template void BatchNormScaleLayer<float>::compute_mean_per_channel_gpu(int N, int C,
    int S, const float *x, float *y);

template void BatchNormScaleLayer<double>::multicast_gpu(int N, int C,
    int S, const double *x, double *y);
template void BatchNormScaleLayer<double>::compute_sum_per_channel_gpu(int N, int C,
    int S, const double *x, double *y);
template void BatchNormScaleLayer<double>::compute_mean_per_channel_gpu(int N, int C,
    int S, const double *x, double *y);
*/
}  // namespace caffe

...
void CuDNNBatchNormScaleLayer<Dtype>::LayerSetUp(
    const vector<Blob<Dtype>*>& bottom,
    const vector<Blob<Dtype>*>& top) {
  BatchNormScaleLayer<Dtype>::LayerSetUp(bottom, top);
...
template <typename Dtype>
void CuDNNBatchNormScaleLayer<Dtype>::Reshape(
    const vector<Blob<Dtype>*>& bottom,
    const vector<Blob<Dtype>*>& top) {
  BatchNormScaleLayer<Dtype>::Reshape(bottom, top);
...
template <typename Dtype>
CuDNNBatchNormScaleLayer<Dtype>::~CuDNNBatchNormScaleLayer() {
...
INSTANTIATE_CLASS(CuDNNBatchNormScaleLayer);
